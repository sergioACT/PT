...
import ViolenciaFamiliarGeneroScreen from '../ViolenciaFamiliarGeneroScreen';

const ViolenciaFamiliarGeneroPanicScreen = props => {
  const {route} = props;
  ...
  return (
    <Screen backgroundColor={COLORS().orange}>
      <LayoutContainer>
        <Container>
          <Row>
...
export default ViolenciaFamiliarGeneroPanicScreen;
